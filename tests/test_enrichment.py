"""
Automated Pytest for child-pugh-turcotte-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MeldVsChildpughComparisonEngine,
    SurgicalRiskStratificationEngine,
    PortalHypertensionStagingEngine,
    TransplantEligibilityTimelineEngine,
    AscitesManagementProtocolEngine,
    HepaticEncephalopathyRiskEngine,
    ChildpughturcottecalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ChildpughturcottecalculatorEnrichmentSuite()
